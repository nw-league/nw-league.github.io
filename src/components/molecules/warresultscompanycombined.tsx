...
import { Crown, Fire, FirstAid, Handshake, Skull, Sword } from "phosphor-react";
        ...
        <div className="grid grid-rows w-full text-white mx-auto">
            ...
            <div className="grid grid-rows-7 w-full text-white mx-auto">
                ...
                <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                    <div className={`${attackerColor} flex items-center justify-center font-bold text-xl md:text-3xl p-2 w-full h-full`}>{summaries[0].name}</div>
                    <div className="bg-gray-700 text-center text-3xl p-2">vs</div>
                    <div className={`${defenderColor} flex items-center justify-center font-bold text-xl md:text-3xl p-2 w-full h-full`}>{summaries[1].name}</div>
                </div>

                {/* Row 2: Kills */}
                <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                    <div className={`${attackerColor} flex items-center justify-center font-semibold text-xl p-2 w-full h-full`}>{<NumberCell value={summaries[0].kills} />}</div>
                    <div className="bg-gray-700 w-full h-full flex items-center justify-center"><Sword weight="fill" size={32} /></div>
                    <div className={`${defenderColor} flex items-center justify-center font-semibold text-xl p-2 w-full h-full`}>{<NumberCell value={summaries[1].kills} />}</div>
                </div>

                {/* Row 3: Deaths */}
                <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                    <div className={`${attackerColor} flex items-center justify-center font-semibold text-xl p-2 w-full h-full`}>{<NumberCell value={summaries[0].deaths} />}</div>
                    <div className="bg-gray-700 w-full h-full flex items-center justify-center"><Skull weight="fill" size={32} /></div>
                    <div className={`${defenderColor} flex items-center justify-center font-semibold text-xl p-2 w-full h-full`}>{<NumberCell value={summaries[1].deaths} />}</div>
                </div>

                {/* Row 4: Assists */}
                <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                    <div className={`${attackerColor} flex items-center justify-center p-2 font-semibold text-xl w-full h-full`}>{<NumberCell value={summaries[0].assists} />}</div>
                    <div className="bg-gray-700 w-full h-full flex items-center justify-center"><Handshake weight="fill" size={32} /></div>
                    <div className={`${defenderColor} flex items-center justify-center p-2 font-semibold text-xl w-full h-full`}>{<NumberCell value={summaries[1].assists} />}</div>
                </div>

                {/* Row 5: Healing */}
                <div className="grid grid-cols-[1fr_50px_1fr] w-full items-center">
                    <div className={`${attackerColor} flex items-center justify-center p-2 font-semibold text-xl w-full h-full`}>{<NumberCell value={summaries[0].healing} />}</div>
                    <div className="bg-gray-700 w-full h-full flex items-center justify-center"><FirstAid weight="fill" size={32} /></div>
                    <div className={`${defenderColor} flex items-center justify-center p-2 font-semibold text-xl w-full h-full`}>{<NumberCell value={summaries[1].healing} />}</div>
                </div>
