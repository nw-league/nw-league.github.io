...
function WarTile({ war }: WarTileProps): JSX.Element {
    return (
        <Link to={`/wars/${war.id}`}>
            <div className="bg-gray-700 text-white w-full h-full flex items-center justify-center rounded-lg p-2">
                <div className="text-center">
                    ...
                    <div className="text-sm text-gray-400">{formatDate(war.date)}</div>
                </div>
